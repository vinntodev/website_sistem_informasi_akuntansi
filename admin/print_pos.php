    ...
    <div id="wrapper">
        <table border="0" style="border-collapse: collapse; width: 100%; height: auto;">
            <tr>
                ...
                <h2 style="padding-top:0px; font-size: 24px;"><strong>Toko Informatika</strong></h2>
            </tr>
            <tr>
                ...
                <td width="100%">
                    <span class="left" style="text-align: left;">Alamat : Jorong Andaleh, Kabupaten Tanah Datar,
                        Sumatera Barat</span>
                    <span class="left" style="text-align: left;">Telepon : 082285640740</span>
                    <span class="left" style="text-align: left;">Tanggal :
                        <?php echo $date; ?>
                    </span>
                </td>
            </tr>
        ...
        <table class="table" cellspacing="0" border="0">
            ...
            <tbody>
                ...
                while ($user_data = mysqli_fetch_array($result)) {
                    echo "<tr>";
                    echo "<td style='text-align: center; width: 30px;' align='top'>" . $no . "</td>";
                    echo "<td style='text-align: left; width: 130px; padding-bottom: 10px;' align='top'>" . $user_data['nama_barang'] . "</td>";
                    echo "<td style='text-align: center; width: 50px; align='top'>" . $user_data['jumlah_barang'] . "</td>";
                    echo "<td style='text-align: center; width: 50px; align='top'>" . $user_data['harga_barang'] . "</td>";
                    echo "<td style='text-align: right; width: 70px; align='top'>" . $user_data['total_jual'] . "</td>";
                    $no++;
                }
                ?>
            </tbody>
        ...
        <table class="total" cellspacing="0" border="0"
            ...
            <tbody>
                <tr>
                    ...
                    <?php
                    $id = $_GET['id'];
                    $result = mysqli_query($koneksi, "SELECT SUM(jumlah_barang) as jumlah_barang FROM tabel_jual WHERE kode_jual = '$id'");
        ...
        <div id="bkpos_wrp">
            <a href="pos.php?id=<?php echo generateRandomString(); ?>"
                style="width: 100%; display: block; font-size: 12px; text-decoration: none; text-align: center; color: #FFF; background-color: #005b8a; border: 0px solid #000;">Kembali
                ke Point of Sales</a>
        </div>
