...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-bold">Poin of Sales</h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div><!-- /.content-header -->
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="jumlahbeli" name="jumlahbeli"
                    placeholder="Enter Jumlah Beli" autocomplete="off">
                  <input type="hidden" class="form-control" id="kodejual" name="kodejual"
          ...
          <div class="card">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  while ($user_data = mysqli_fetch_array($result)) {
                    ...
                    // echo "<td>"."<a href='delete_proses.php?id=$user_data[id_barang]'><span class='badge bg-danger'>Hapus</span></a>"."</td></tr>";
                    $no++;
                  }
                  ?>
                </tbody>
            ...
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control text-right" id="totalbayar"
                    value="<?php echo rupiah1($totalbayar); ?>" placeholder="Total Bayar" readonly>
                </div>
              </div>
              <div class="card-footer">
                <button type="submit" name="submit" class="btn btn-success"
                  onclick="location.href='print_pos.php?id=<?php echo $id = $_GET['id']; ?>'">Bayar</button>
                <button type="submit" name="submit" class="btn btn-danger"
                  onclick="location.href='delete_pos.php?id=<?php echo $id = $_GET['id']; ?>'">Cancel</button>
              </div>
            </div>
          </div>
        </div>
